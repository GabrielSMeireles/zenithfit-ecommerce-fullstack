...
// @ts-nocheck 
/*
 * This file exports the `Status_cliente` model and its related types.
 *
...
export type GetStatus_clienteAggregateType<T extends Status_clienteAggregateArgs> = {
      [P in keyof T & keyof AggregateStatus_cliente]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateStatus_cliente[P]>
    : Prisma.GetScalarType<T[P], AggregateStatus_cliente[P]>
}
...
type GetStatus_clienteGroupByPayload<T extends Status_clienteGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Status_clienteGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Status_clienteGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Status_clienteGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Status_clienteGroupByOutputType[P]>
      }
    >
  >
...
export type Status_clienteCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<Status_clienteFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface Status_clienteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Status_cliente'], meta: { name: 'Status_cliente' } }
  /**
   ...
   * })
  **/
  count<T extends Status_clienteCountArgs>(
    args?: Prisma.Subset<T, Status_clienteCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Status_clienteCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends Status_clienteGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, Status_clienteGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetStatus_clienteGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
